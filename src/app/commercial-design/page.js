...
const COMMERCIAL_PROJECTS = [
  {
    ...
    intro: "这是一次围绕微信支付人工客服全链路展开的体验改版，覆盖接入、排队、会话与评价流程。",
    paragraphs: [
  ...
  },
  {
    ...
    intro: "这是为微信支付线下商户设计的马年春节年历海报，以“支付猫”和节庆意象构建品牌视觉。",
    paragraphs: [
  ...
  },
  {
    ...
    intro: "这是围绕微信经营助手展开的智能体验与 IP 动效探索，让“支付猫”能够在对话中表达状态与情绪。",
    paragraphs: [
  ...
  },
  {
    ...
    intro: "这是飞书 ToB 品牌传播与获客相关的视觉设计实践，覆盖企业手册、H5 与线上传播物料。",
    paragraphs: [
  ...
  },
  {
    ...
    intro: "这是飞书 2024 未来无限大会的全链路视觉设计，涵盖主视觉探索、物料延展与现场落地。",
    paragraphs: [
